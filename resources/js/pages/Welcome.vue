...
// Campos para el área de terreno
const landAreaName = ref('');
const landAreaDescription = ref('');
...
const clearArea = () => {
    if (landAreaSelectorRef.value) {
        ...
        // Limpiar también los campos de nombre y descripción
        landAreaName.value = '';
        landAreaDescription.value = '';
    }
};

// Función para actualizar los campos ocultos del formulario
const updateHiddenFields = () => {
    // Esta función ya no es necesaria porque usamos binding reactivo
};
...
// Función para validar que se haya seleccionado un área antes de enviar
const validateAreaSelection = () => {
    return isAreaValid.value;
};

// Observar cambios en los campos de nombre y descripción
watch([landAreaName, landAreaDescription], updateHiddenFields);
